metadata title = 'Block IP - Palo Alto PAN-OS'
metadata description = 'This playbook allows blocking/allowing of IPs in PAN-OS, using a address object group. The address object group itself should be attached to a pre-defined security policy rule.'
metadata mainSteps = [
...
param PlaybookName string = 'PaloAlto-PAN-OS-BlockIP'
